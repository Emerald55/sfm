...
class keybinds {
	public:
		...
		void move_left(user_interface &ui, std::string &search_str);
		void move_right(user_interface &ui, const std::string &selected_filepath, std::string &search_str);
		...
		void search(user_interface &ui, std::string &search_str);
